...
export default async function HomePage({
  ...
  return (
    <>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-b from-white to-gray-50">
        <PageContainer>
          <div className="max-w-5xl mx-auto">
            <div className="rounded-3xl overflow-hidden shadow-brand-xl ring-4 ring-brand-blue/5 bg-gray-900">
              <video
                controls
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-lg text-gray-600">{t.video.subtitle}</p>
            </div>
          </div>
        </PageContainer>
      </section>
      ...
      {/* Applications */}
      <section id="applications" className="py-16 sm:py-20 bg-gradient-to-b from-white via-gray-50/50 to-white">
        <PageContainer>
      ...
      {/* Sustainability */}
      <section id="sustainability" className="py-16 sm:py-20 bg-gradient-to-b from-gray-50/50 via-white to-gray-50/30">
        <PageContainer>
